	...
	for {
		...
		for _, s := range next {
			...
			if !visitedStates[s.podLocations] {
				// if i, ok := bestStateMap[s.podLocations]; ok {
				// 	fmt.Println("state", i, "(", s, "(competing with possible nexts:", next)
				// }
				heap.Push(sh, s)
			}
		}
...
var (
	bestStates = [][16]Location{
		{10, 17, 20, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 5},
		{10, 17, 20, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 19, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 4, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 3, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 2, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 1, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 0, 22, 7, 13, 15, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 0, 22, 7, 13, 4, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 0, 22, 7, 13, 5, 16, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 0, 22, 7, 13, 5, 15, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 17, 0, 22, 7, 13, 5, 4, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 16, 0, 22, 7, 13, 5, 4, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 15, 0, 22, 7, 13, 5, 4, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 3, 0, 22, 7, 13, 5, 4, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 2, 0, 22, 7, 13, 5, 4, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 11, 12, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 3, 12, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 15, 12, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 16, 12, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 17, 12, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 17, 11, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 17, 3, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 17, 15, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 13, 5, 4, 17, 16, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 12, 5, 4, 17, 16, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 11, 5, 4, 17, 16, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 3, 5, 4, 17, 16, 18, 21, 8, 9, 14, 6},
		{10, 1, 0, 22, 7, 3, 5, 4, 17, 16, 18, 21, 8, 9, 13, 6},
		{10, 1, 0, 22, 7, 3, 5, 4, 17, 16, 18, 21, 8, 9, 12, 6}, {10, 1, 0, 22, 7, 3, 5, 4, 17, 16, 18, 21, 8, 9, 11, 6}, {10, 1, 0, 22, 7, 3, 5, 4, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 11, 5, 4, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 12, 5, 4, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 13, 5, 4, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 5, 4, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 5, 3, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 5, 11, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 5, 12, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 5, 13, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 4, 13, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 3, 13, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 11, 13, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 12, 13, 17, 16, 18, 21, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 12, 13, 17, 16, 18, 20, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 12, 13, 17, 16, 18, 19, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 12, 13, 17, 16, 18, 4, 8, 9, 2, 6}, {10, 1, 0, 22, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 2, 6}, {10, 1, 0, 21, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 2, 6}, {10, 1, 0, 20, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 2, 6}, {10, 1, 0, 19, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 2, 6}, {10, 1, 0, 5, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 2, 6}, {10, 1, 0, 5, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 3, 6}, {10, 1, 0, 5, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 4, 6}, {10, 1, 0, 5, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 19, 6}, {10, 1, 0, 5, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 20, 6}, {10, 1, 0, 5, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 21, 6}, {10, 1, 0, 5, 7, 14, 12, 13, 17, 16, 18, 15, 8, 9, 22, 6}, {10, 1, 0, 5, 2, 14, 12, 13, 17, 16, 18, 15, 8, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 8, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 7, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 2, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 3, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 4, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 19, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 20, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 9, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 8, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 7, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 2, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 3, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 4, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 19, 22, 6}, {10, 1, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 7, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 8, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 0, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 1, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 7, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 8, 5, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 8, 4, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 8, 3, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 8, 2, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 8, 7, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 6}, {10, 9, 8, 7, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 5}, {10, 9, 8, 7, 11, 14, 12, 13, 17, 16, 18, 15, 21, 20, 22, 19}}
	bestStateMap = makeMap(bestStates)
)

func (s state) value() int {
	// if _, found := bestStateMap[s.podLocations]; found {
	// 		return -10000000
	// }
	var value int
	for i := Pod(0); i < 4; i++ {
...
func makeMap(bestStates [][16]Location) map[[16]Location]int {
	bsm := map[[16]Location]int{}
	for i, loc := range bestStates {
		bsm[loc] = i
	}
	return bsm
}
